...
def bootstrap():
    ...
    do_cmd('cl vmmain.c /D "inline=" /Od /Zi /MDd /Fdvm.pdb /Fmvm.map /Fevm.exe')
    ...
    build_bc()
    do_cmd('cl /Od /MDd tpmain.c /D "inline=" /Zi /Fdtinypy.pdb /Fmtinypy.map /Fetinypy.exe')
    ...
    build_bc(True)
    do_cmd('cl /Os vmmain.c /D "inline=__inline" /D "NDEBUG" /MD /Gy /GL /Zi /Fdvm.pdb /Fmvm.map /Fevm.exe /link /opt:ref /opt:icf')
    do_cmd('cl /Os tpmain.c   /D "inline=__inline" /D "NDEBUG" /MD /Gy /GL /Zi /Fdtinypy.pdb /Fmtinypy.map /Fetinypy.exe /link /opt:ref /opt:icf')
    do_cmd("tinypy.exe tests.py -win")
    do_cmd("dir *.exe")
